...
def load_infections():
    ...
    with pkg_resources.files("pandemic.variables").joinpath("infection_cards.txt").open("r", encoding="utf-8") as file:
...
def load_player_cards():
    ...
    with pkg_resources.files("pandemic.variables").joinpath("other_cards.txt").open("r", encoding="utf-8") as file:
